...
SMPL_EDGES = [
    # Spine chain
    (0, 9), (9, 10), (10, 11), (11, 12), (12, 13),  # Pelvis -> Torso -> Spine -> Chest -> Neck -> Head
    # Left arm
    (11, 14), (14, 15), (15, 16), (16, 17), (17, 18),  # Chest -> L_Thorax -> L_Shoulder -> L_Elbow -> L_Wrist -> L_Hand
    # Right arm
    (11, 19), (19, 20), (20, 21), (21, 22), (22, 23),  # Chest -> R_Thorax -> R_Shoulder -> R_Elbow -> R_Wrist -> R_Hand
    # Left leg
    (0, 1), (1, 2), (2, 3), (3, 4),  # Pelvis -> L_Hip -> L_Knee -> L_Ankle -> L_Toe
    # Right leg
    (0, 5), (5, 6), (6, 7), (7, 8),  # Pelvis -> R_Hip -> R_Knee -> R_Ankle -> R_Toe
]
...
def get_skeleton_layout(
    ...
    if layout == "smpl":
        ...
        if custom_edges is None or custom_num_nodes is None:
            raise ValueError("custom_edges and custom_num_nodes required for custom layout")
