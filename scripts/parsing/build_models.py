...
Usage:
    ...
    uv run scripts/parsing/build_models.py --programs ../exact_data/programs/parsed/programs_train.json
    
    # Build models with program budget (select diverse subset)
    uv run scripts/parsing/build_models.py --programs ../exact_data/programs/parsed/programs_train.json --program-budget 50
    
    # Custom output path
    uv run scripts/parsing/build_models.py --programs ../exact_data/programs/parsed/programs_train.json --output ../exact_data/models/models.json
"""
