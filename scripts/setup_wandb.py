...
def main():
    ...
    print("=" * 60)
    print("WandB Setup for EXACT GRPO Training")
    print("=" * 60)
    print()
    ...
    print("   python scripts/train_grpo.py \\")
    ...
    print("   python scripts/train_grpo.py wandb.mode=disabled")
    print()
    print("4. Run offline (sync later):")
    print("   python scripts/train_grpo.py wandb.mode=offline")
    ...
    print("   python scripts/train_grpo.py training=fast data=small")
    print()
    print("2. Check your WandB dashboard:")
    print(f"   https://wandb.ai/{user.username}/exact-grpo")
    print()
